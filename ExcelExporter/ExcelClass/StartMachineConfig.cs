...
namespace ET
{
    ...
    public partial class StartMachineConfigCategory : ProtoObject
    {
		...
		[BsonElement]
		[ProtoMember(1)]
		private List<StartMachineConfig> StartMachineConfigList = new List<StartMachineConfig>();
        ...
        {
			foreach (StartMachineConfig config in StartMachineConfigList)
			{
				this.dict.Add(config.Id, config);
			}
			StartMachineConfigList.Clear();
