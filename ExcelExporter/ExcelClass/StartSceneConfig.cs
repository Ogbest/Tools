...
namespace ET
{
    ...
    public partial class StartSceneConfigCategory : ProtoObject
    {
		...
		[BsonElement]
		[ProtoMember(1)]
		private List<StartSceneConfig> StartSceneConfigList = new List<StartSceneConfig>();
        ...
        {
			foreach (StartSceneConfig config in StartSceneConfigList)
			{
				this.dict.Add(config.Id, config);
			}
			StartSceneConfigList.Clear();
