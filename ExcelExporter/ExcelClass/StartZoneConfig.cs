...
namespace ET
{
    ...
    public partial class StartZoneConfigCategory : ProtoObject
    {
		...
		[BsonElement]
		[ProtoMember(1)]
		private List<StartZoneConfig> StartZoneConfigList = new List<StartZoneConfig>();
        ...
        {
			foreach (StartZoneConfig config in StartZoneConfigList)
			{
				this.dict.Add(config.Id, config);
			}
			StartZoneConfigList.Clear();
