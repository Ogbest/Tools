...
namespace ET
{
    ...
    public partial class StartProcessConfigCategory : ProtoObject
    {
		...
		[BsonElement]
		[ProtoMember(1)]
		private List<StartProcessConfig> StartProcessConfigList = new List<StartProcessConfig>();
        ...
        {
			foreach (StartProcessConfig config in StartProcessConfigList)
			{
				this.dict.Add(config.Id, config);
			}
			StartProcessConfigList.Clear();
